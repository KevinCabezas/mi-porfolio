...
export default function ModalProject({ img, onClose }: Props) {
  ...
  return (
    <div className="bg-gray-300/30 h-screen w-screen backdrop-blur-md px-62.5 fixed py-10 left-0 top-0 z-50 ">
      <div className="bg-white h-full rounded-xl overflow-y-auto space-y-5 ">
        <div className="flex justify-between p-6 border-b border-gray-100">
          <div className="flex items-center gap-2 ">
            ...
            <div className="space-y-0.5">
              <h2 className="font-bold text-xl text-gray-900 ">API REST Node.js</h2>
        ...
        <div className="px-6 space-y-6 pb-6">
          ...
          <div className="flex gap-3 pt-2 border-t border-gray-100">
            <a className="flex items-center gap-2 px-4 py-2.5 bg-gray-900 hover:bg-gray-700 text-white text-sm font-medium rounded-full transition-colors cursor-pointer whitespace-nowrap">
